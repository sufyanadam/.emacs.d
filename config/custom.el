(custom-set-variables
 ...
 '(connection-local-criteria-alist
   '(((:application vc-git) vc-git-connection-default-profile)
     ((:application tramp :machine "LEO-A-e4b486032")
 ...
 '(package-selected-packages
   '(ac-inf-ruby ac-js2 ac-slime ace-jump-mode afternoon-theme ag
                 ...
                 edit-indirect elisp-slime-nav elixir-mode emms
                 emms-player-simple-mpv emojify enh-ruby-mode eproject
                 erlang erlang-ts ert-async evil-mc evil-smartparens
                 exec-path-from-shell exunit exwm exwm-edit
                 exwm-firefox-core exwm-firefox-evil exwm-mff
                 exwm-surf exwm-x fancy-narrow feature-mode
                 fill-column-indicator find-file-in-project flx-ido
                 flycheck fold-this geiser gist git-gutter-fringe
                 git-messenger gitconfig-mode gitignore-mode god-mode
                 gptel guide-key highlight-escape-sequences
                 ...
                 idomenu impatient-mode import-js inf-elixir jabber
                 js2-refactor jsx-mode jump-char lsp-mode lsp-vue
                 lua-mode magit markdown-mode markdown-preview-mode
                 monokai-theme move-text multifiles naquadah-theme
                 neotree nodejs-repl ob-elixir org org-beautify-theme
                 org-bullets org-plus-contrib org-present
                 org-tree-slide pallet pandoc paredit parse-csv
                 pdf-tools prettier-js pretty-symbols project-explorer
                 projectile rainbow-mode rbenv restclient rhtml-mode
                 rinari robe rsense rspec-mode ruby-tools rvm
                 sass-mode scss-mode simplezen skewer-less slim-mode
                 slime-repl-ansi-color smart-forward smex
                 smooth-scrolling spacegray-theme sublime-themes
                 swift-mode tagedit tern-auto-complete terraform-mode
                 tide tree-sitter treemacs treemacs-evil
